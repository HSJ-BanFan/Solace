...
RUNTIME_CONFIG="<script>window.__RUNTIME_CONFIG__={API_BASE:\"${VITE_API_BASE}\",SITE_BASE_URL:\"${SITE_BASE_URL}\",SITE_NAME:\"${SITE_NAME}\",SITE_DESCRIPTION:\"${SITE_DESCRIPTION}\"};</script>"
