...
/** 加载状态组件 */
export function LoadingState({ message = '加载中...', className = '', inline }: LoadingStateProps) {
  if (inline) {
    return (
...
/** 内联加载指示器（兼容旧接口） */
export const InlineLoader = (props: Omit<LoadingStateProps, 'message' | 'inline'>) => <LoadingState {...props} inline />;
